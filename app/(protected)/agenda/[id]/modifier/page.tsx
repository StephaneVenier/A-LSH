...
export default async function EditEventPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!data) notFound();
  return <main className="mx-auto max-w-3xl space-y-6"><div><p className="eyebrow">Agenda</p><h1 className="page-title">Modifier l’événement</h1><p className="page-subtitle">Mettez à jour les informations de cet événement privé.</p></div><EventForm event={data as EventRecord} /></main>;
}
